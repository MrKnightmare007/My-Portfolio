...
const gradientMapping = {
  ...
  teal: "linear-gradient(hsl(180, 90%, 40%), hsl(165, 90%, 40%))",
  pink: "linear-gradient(hsl(330, 90%, 50%), hsl(315, 90%, 50%))",
  yellow: "linear-gradient(hsl(60, 90%, 50%), hsl(45, 90%, 50%))",
  cyan: "linear-gradient(hsl(195, 90%, 50%), hsl(180, 90%, 50%))",
  magenta: "linear-gradient(hsl(300, 90%, 50%), hsl(285, 90%, 50%))",
  lime: "linear-gradient(hsl(75, 90%, 50%), hsl(60, 90%, 50%))",
};
...
const GlassIcons = ({ items, className }) => {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div
        className={`relative z-10 grid gap-[4em] grid-cols-2 md:grid-cols-6 mx-auto py-[3em] overflow-visible ${className || ""}`}
      >
        {items.map((item, index) => (
          <button
            ...
            className={`relative bg-transparent outline-none w-[6em] h-[6em] [perspective:24em] [transform-style:preserve-3d] [-webkit-tap-highlight-color:transparent] group ${item.customClass || ""}`}
          >
            <span
            ...
            >
              <span className="m-auto w-[2.5em] h-[2.5em] flex items-center justify-center text-black" aria-hidden="true">
                {item.icon}
              </span>
            </span>
