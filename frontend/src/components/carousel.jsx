        ...
        <div className="[perspective:1200px] [transform-style:preserve-3d]">
            <li
                ...
                <div
                    ...
                    <img
                        className="absolute inset-0 w-[100%] h-[100%] object-cover opacity-100 transition-all duration-600 ease-in-out"
                        style={{
                            opacity: current === index ? 1 : 0.5,
                            filter: current === index ? "brightness(1.2)" : "brightness(0.8)",
                        }}
                        alt={title}
                        src={src}
                        onLoad={imageLoaded}
...
const CarouselControl = ({
    ...
    return (
        <button
            className="carousel-control-button w-12 h-12 flex items-center mx-2 justify-center bg-neutral-200 dark:bg-neutral-800 border-3 border-transparent rounded-full focus:border-[#6D64F7] focus:outline-none hover:-translate-y-0.5 active:translate-y-0.5 transition duration-200"
            title={title}
            onClick={handleClick}>
            {type === "previous" ? (
